...
module.exports = __webpack_require__.p + "config.html";
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {bgColor: a, fontSize: b, mdl: c};
	});
var _user$project$Main$init = A3(_user$project$Main$Model, _debois$elm_mdl$Material_Color$Teal, 24, _debois$elm_mdl$Material$model);
...
var _user$project$Main$buttons = F2(
	function (model, _p1) {
		var _p2 = _p1;
		var _p3 = _p2._1;
		return A5(
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onClick(
								_user$project$Main$ChangeColor(_p3)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$view = function (model) {
	return A3(
		...
		model.bgColor,
		_debois$elm_mdl$Material_Color$Pink,
		A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			A2(
