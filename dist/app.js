...
const {ipcRenderer, remote} = __webpack_require__(3);
...
var _user$project$Port$focus_ = _elm_lang$core$Native_Platform.outgoingPort(
	'focus_',
	function (v) {
		return null;
	});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('titleBar'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
